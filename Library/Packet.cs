    ...
    public abstract class Packet
    {
        ...
        static Packet()
        {
            ...
            Packets.Sort((x1, x2) =>
            {
                ...
                if (string.Compare(x1.Namespace, @"Library.GeneralPackets", StringComparison.Ordinal) == 0) //We want General Packets shifted To the top.
                    return -1;

                if (string.Compare(x2.Namespace, @"Library.GeneralPackets", StringComparison.Ordinal) == 0) //We want General Packets shifted To the top.
                    return 1;
